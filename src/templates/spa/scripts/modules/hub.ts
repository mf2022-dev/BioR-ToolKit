      ...
      '<div class="hub-section hub-sec-kb">' +
        ...
        '<div class="hub-dl-grid">' +
          ...
          '<div class="hub-dl-card" style="border-color:rgba(239,68,68,0.15)" data-ext-url="https://tabletap-axb.pages.dev/hub" onclick="openExtUrl(this.dataset.extUrl)">' +
            ...
            '<div class="hub-dl-card-meta">' +
              '<span class="hub-dl-card-tag"><i class="fas fa-chess-board"></i>9 Exercises</span>' +
              '<span class="hub-dl-card-tag"><i class="fas fa-clock"></i>1983\u20132019</span>' +
              '<span class="hub-dl-card-tag"><i class="fas fa-biohazard"></i>4 Categories</span>' +
              '<span class="hub-dl-card-tag"><i class="fas fa-skull-crossbones"></i>1.5B+ Deaths</span>' +
            '</div>' +
            '<div class="hub-dl-card-actions">' +
              '<button class="hub-dl-btn hub-dl-btn-explore" style="background:linear-gradient(135deg,#dc2626,#ef4444);color:#fff" data-ext-url="https://tabletap-axb.pages.dev/hub" onclick="event.stopPropagation();openExtUrl(this.dataset.extUrl)"><i class="fas fa-external-link-alt"></i> Explore</button>' +
            '</div>' +
          '</div>' +
        '</div>' +
      '</div>' +
