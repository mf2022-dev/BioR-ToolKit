    ...
    '<div class="hub-body">' +
      ...
      '<div class="hub-section hub-sec-kb">' +
        ...
        '<div class="hub-dl-grid">' +
          ...
          '<div class="hub-dl-card" style="border-color:rgba(239,68,68,0.15)" data-ext-url="https://tabletap-axb.pages.dev/" onclick="openExtUrl(this.dataset.extUrl)">' +
            ...
            '</div>' +
            '<div class="hub-dl-card-actions">' +
              '<button class="hub-dl-btn hub-dl-btn-explore" style="background:linear-gradient(135deg,#dc2626,#ef4444);color:#fff" data-ext-url="https://tabletap-axb.pages.dev/" onclick="event.stopPropagation();openExtUrl(this.dataset.extUrl)"><i class="fas fa-external-link-alt"></i> Explore</button>' +
            '</div>' +
          '</div>' +
        '</div>' +
      '</div>' +
